...
.chip.green.on{background:var(--brown);border-color:var(--brown);color:#fff}
...
.tag.track-med{background:var(--brown);color:#fff;border-color:var(--brown);font-weight:700}
...
footer .ok{color:var(--brown)}footer .bad{color:var(--org)}
...
<div class="hero">
  <h1>🎓 長照 × 醫事人員積分課程搜尋</h1>
  <p class="sub">長照人員繼續教育 ＋ 醫事各職類學會/公會課程 ＋ 照顧者活動彙整（__NSOURCES__ 個資料來源）</p>
  <div class="badges">
...
AUDIENCES = ["照顧服務人員", "居家服務督導員", "社會工作人員", "醫事人員", "照顧管理人員", "A個管", "教保員", "家庭照顧者"]
CATEGORIES = ["失智症", "復能/復健", "吞嚥/營養", "心理/情緒", "感染管制", "安全照護", "安寧/緩和",
              "慢性病照護", "用藥安全", "身心障礙", "家庭照顧者", "輔具/無障礙", "口腔照護",
              "性別敏感度", "勞安/職安", "專業課程", "專業品質", "專業倫理", "專業法規"]
